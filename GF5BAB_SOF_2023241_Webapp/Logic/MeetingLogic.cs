...
namespace GF5BAB_SOF_2023241_Webapp.Logic
{
    public class MeetingLogic
    {
        ...
        /*public Meeting SetTeamPrincipal(Meeting meeting, ControllerBase controller)
        {
            meeting.TeamPrincipalId = _userManager.GetUserId(controller.User);
            meeting.TeamPrincipal = _userManager.Users.FirstOrDefault(t => t.Id == meeting.TeamPrincipalId);
            return meeting;
        }*/
